...
//
// NB Iter_type could be a std::string iterator, wstring iterator, a position iterator
// or a multipass iterator
//
...
public:
    ...
    static void throw_not_hex(Iter_type begin, Iter_type) {
    ...
    public:
        definition(const Json_grammar& self) {
            ...
            Str_action new_identifier(boost::bind(&Semantic_actions_t::new_identifier,
                                                  &self.actions_, _1, _2));
            Str_action new_str(
                    boost::bind(&Semantic_actions_t::new_str, &self.actions_, _1, _2));
            Str_action new_true(
                    boost::bind(&Semantic_actions_t::new_true, &self.actions_, _1, _2));
            Str_action new_false(boost::bind(&Semantic_actions_t::new_false,
                                             &self.actions_, _1, _2));
            Str_action new_null(
            ...
            Str_action new_infinity(boost::bind(&Semantic_actions_t::new_infinity,
                                                &self.actions_, _1, _2));
            Str_action new_minus_infinity(boost::bind(
                    &Semantic_actions_t::new_minus_infinity, &self.actions_, _1, _2));
            Int_action new_int(
            ...
            value_ = single_quoted_string_[new_str] | double_quoted_string_[new_str] |
                     number_ | object_ | array_ | str_p("true")[new_true] |
            ...
            pair_ = (double_quoted_string_[new_name] | identifier_[new_identifier]) >>
            ...
            number_ = (str_p("0x") >> (hex_p[new_int] | eps_p[&throw_not_hex])) |
        ...
        spirit_namespace::rule<ScannerT> json_, object_, members_, pair_, array_,
                elements_, value_, single_quoted_string_, double_quoted_string_,
                number_, identifier_;
...
// reads a JSON Value from a pair of input iterators throwing an exception on invalid
// input, e.g.
//
// string::const_iterator start = str.begin();
// const string::const_iterator next = read_range_or_throw( str.begin(), str.end(),
// value );
//
